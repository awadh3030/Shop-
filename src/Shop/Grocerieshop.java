			...
			if (username.equals(user) && password.equals(pass)) {
				...
				while (condition) {
					...
					case 0:
						...
						String sql01 = "CREATE TABLE shop (" + "shop_name  VARCHAR(50) Primary Key,"
								+ "Email varchar(50) not null," + "Tel int, " + "Fax VARCHAR(50), "
								+ "Website VARCHAR(50))";

						st.executeUpdate(sql01);

						String sql02 = "CREATE TABLE AddItems(" + " item_ID int PRIMARY KEY,"
								+ " item_name VARCHAR(50)," + " unit_price_item int ," + " quantity_item int ,"
								+ " amount_price_item int," + ")";

						st.executeUpdate(sql02);

						String sql03 = " CREATE TABLE Invoice (" + " customer_Name VARCHAR(50) PRIMARY KEY,"
								+ " phone_number int," + " invoice_date VARCHAR(255)," + " id_items INTEGER ,"
								+ " item_name VARCHAR(50) ," + " unit_price DECIMAL(10,2) ," + " quantity int ,"
								+ " amount_price DECIMAL(10,2)," + " total_amount DECIMAL(10,2) ,"
								+ "  paid_amount DECIMAL(10,2) ," + "  balance DECIMAL(10,2) ," + ")";
					...
					case 2:
						...
						if (b == 1) {
							...
							try {
								...
								String sql1 = "INSERT INTO AddItems (item_ID, item_name,unit_price_item, quantity_item, amount_price_item) VALUES('"
										+ aa + "','" + ab + "','" + ac + "','" + ad + "','" + ae + "')";
...
//					stack2.push("Price: " + newValue);
							...
							String sql = "UPDATE AddItems SET unit_price_item = " + UPDATE1 + "WHERE item_ID = "
									+ UPDATE;
...
//					}
							...
							String sql = "select * from AddItems" ;
							 ...
							 System.out.println("unit_price_item = " + resultSet.getString("unit_price_item"));
							 System.out.println("quantity_item = " + resultSet.getString("quantity_item"));
							 System.out.println("amount_price_item = " + resultSet.getString("amount_price_item"));
...
//						System.out.println("serialized and saved");
							...
							String sql1 = "INSERT INTO Invoice (customer_Name, phone_number,invoice_date, "
									...
									+ "total_amount,paid_amount,balance) VALUES('" + Invoice0 + "','" + Invoice1 + "','"
									+ Invoice2 + "','" + Invoice3 + "','" + item + "','" + item1 + "','" + item2 + "','"
									+ item3 + "','" + Invoice4 + "','" + Invoice5 + "','" + Invoice6 + "')";
